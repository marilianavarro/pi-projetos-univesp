...
class ProjetoForm extends TPage
{
    ...
    private static $formName = 'form_ProjetoForm';
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Título:", null, '14px', null, '100%'),$titulo]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $messageAction->setParameter("projeto_id", "{$object->id}"); 
